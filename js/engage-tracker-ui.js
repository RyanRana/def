...
(function (global) {
  ...
  var LERP_SPEED = 0.28;     // per frame, how fast display catches up to target
  ...
  var _lastGraphDraw = 0;
  var GRAPH_INTERVAL_MS = 50;
  ...
  function startGraphAnimationLoop(panel) {
    ...
    function tick() {
      ...
      if (now - _lastGraphDraw >= GRAPH_INTERVAL_MS) {
        _lastGraphDraw = now;
